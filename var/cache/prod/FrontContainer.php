...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '8888', 'dbname' => 'testpresta', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/modules/productcomments/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/modules/ps_checkout/src/Entity']);
        $e->addExcludePaths([0 => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/modules/ps_checkout/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_637091b3ba097658ac05eea15ecf26d4b876942d8c0626a954551ffb6a47df4b');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/var/cache/prod//localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.2', '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test', false);
    }
    ...
    {
        return $this->services['ps_checkout.cache.paypal.merchant_integration'] = new \Symfony\Component\Cache\Simple\FilesystemCache('merchant-integration', 86400, ${($_ = isset($this->services['ps_checkout.cache.directory']) ? $this->services['ps_checkout.cache.directory'] : ($this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.2', '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test', false))) && false ?: '_'}->getPath());
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.2', '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/app',
            'kernel.project_dir' => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/var/cache/prod/',
            ...
            'ps_cache_dir' => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/Users/devweb-creation/Desktop/DevWeb - Creation/htdocs/test/var/cache/prod//doctrine/orm/Proxies',
